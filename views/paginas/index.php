        ...
        <?php foreach($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="build/img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
