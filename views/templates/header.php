        ...
        <nav class="header__navegacion">
            ...
            <?php if(is_auth()) { ?>
                ...
                <form method="POST" action="/logout" class="header__form">
                    <input type="submit" class="header__submit--logout" value="Cerrar Sesión">
                </form>
            <?php } else { ?>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
           ...
           <a href="/finalizar-registro" class="navegacion__enlace <?php echo pagina_actual('/finalizar-registro') || pagina_actual('/boleto') ? 'navegacion__enlace--actual' : ''; ?>">Comprar Pase</a> 
        </nav>
    </div>
</div>